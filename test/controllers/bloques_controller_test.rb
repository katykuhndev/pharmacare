...
class BloquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bloque" do
    assert_difference('Bloque.count') do
      post bloques_url, params: { bloque: { fin: @bloque.fin, inicio: @bloque.inicio, nombre: @bloque.nombre, observaciones: @bloque.observaciones } }
    end
  ...
  test "should update bloque" do
    patch bloque_url(@bloque), params: { bloque: { fin: @bloque.fin, inicio: @bloque.inicio, nombre: @bloque.nombre, observaciones: @bloque.observaciones } }
