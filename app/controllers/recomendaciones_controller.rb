class RecomendacionesController < ApplicationController
  ...
  def update
       puts 'rec_params'
       puts recomendacion_params.inspect 
    respond_to do |format|
  ...
  private
    ...
    def recomendacion_params
      params.require(:recomendacion).permit(:paciente,:id_recomendacion, :estado, :resultado, :caso_id, :programa_id, :paciente_id, :medico_id, :prestador_id, :farmacia_id, :qf_soporte_id, :ejecutivo_id, :fecha_hora_ingreso, :via_ingreso, :fecha_hora_respuesta, :observaciones, :con_alarma)
    end
end
