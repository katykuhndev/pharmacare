class CasosController < ApplicationController
  ...
  private
    ...
    def caso_params
      params.require(:caso).permit(:codigo, :programa_id, :medico_id, :paciente_id, :qf_soporte_id, :ejecutivo_id, :fecha_hora_ingreso, :via_ingreso, :fecha_hora_cierre, :observaciones)
    end
end
